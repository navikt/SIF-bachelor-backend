...
import com.bachelor.vju_vm_apla2.Config.WireMockConfig;
...
@Configuration
public class DokStubs {

    static private WireMockServer wireMockServer;

    @Autowired
    public DokStubs(WireMockServer wireMockServer) {
    ...
    public void configureStubs() {
        ...
        wireMockServer.stubFor(post(urlEqualTo("/mock/dokarkiv"))
